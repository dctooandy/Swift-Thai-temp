...
- (WMZSlider *)slider{
    if (!_slider) {
        ...
        _slider.thumbTintColor = [UIColor colorWithRed: 0.22 green: 0.42 blue: 0.93 alpha:1.0];
        _slider.minimumTrackTintColor = [UIColor colorWithRed: 0.22 green: 0.42 blue: 0.93 alpha:1.0];
    }
    return _slider;
}
