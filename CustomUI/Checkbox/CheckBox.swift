...
class CheckBox: UIView {
    ...
    var checkBackgroundColor: UIColor = .blue
    ...
    init(boxColor: UIColor = .blue, borderColor: UIColor, alwaysShowTick: Bool = false) {
        super.init(frame: .zero)
        self.checkBackgroundColor = boxColor
        self.checkBorderColor = boxColor
        self.uncheckBorderColor = borderColor
        self.alwaysShowTick = alwaysShowTick
        setupViews()
    }
    
    init(boxColor: UIColor = .blue) {
        super.init(frame: .zero)
        self.checkBackgroundColor = boxColor
        self.checkBorderColor = boxColor
        self.uncheckBorderColor = boxColor
        setupViews()
    }
